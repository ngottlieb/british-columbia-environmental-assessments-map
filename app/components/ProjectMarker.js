...
export default class ProjectMarker extends React.Component {
  ...
  render() {
    return (
      <Marker
        position={[this.props.centroid[1], this.props.centroid[0]]}
      ...
      >
        <Popup>
          ...
          <dl>
            ...
            <dt>Decision Date</dt>
            <dd>
              {this.props.decisionDate
                ? moment(this.props.decisionDate).format("MMMM Do YYYY")
                : "N/A"}
            </dd>
            <dt>Proponent</dt>
          ...
          <a target="_blank" href={this.projectUrl()}>
            More Info
          </a>
        </Popup>
      </Marker>
  ...
  projectUrl() {
    return "https://projects.eao.gov.bc.ca/p/" + this.props._id;
  }
